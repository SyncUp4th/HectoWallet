...
const ASSETS = [
  { symbol: 'USDT', name: 'Tether USD (연동 테스트용)', balance: 500, address: '0xa1c2...9f3d' },
...
const HECTO_SYMBOLS = HECTO_COINS.map((c) => c.symbol)
  ...
  async getTransactions() {
    ...
    return {
      ...
      items: [
        ...
        { hash: '0xe210...9a3b', type: 'transfer', fromCompany: '테스트월렛', toCompany: '헥토파이낸셜', flow: '1,000 USDT', status: 'failed', time: '41분 전' },
      ],
    }
  },
